...
namespace PTMK_Test.Application.Implementation.Application.Queries
{
    public readonly record struct GetAllApplicationsQuery(
        PaginationParameters Pagination) : IRequest<RequestResult<List<Core.Implementation.Models.Application>>>;

    public sealed class GetAllApplicationsHandler(IDbContext dbContext)
        : IRequestHandler<GetAllApplicationsQuery, RequestResult<List<Core.Implementation.Models.Application>>>
    {
